...
public class MainActivity extends BaseActivity
  ...
  @Override public void updatePhotoLikeCounter(String photoId, String userId, int likeTapFlags) {
    feedAdapter.updatePhotoLikeCounter(photoId, userId, likeTapFlags);
  }
  ...
  @Override public void showErrorWhileSigningOut() {

  }

  @Override public void addLikeNotifiers() {
  ...
  @Override public void removeLikeNotifiers() {
    List<FeedItem> feedItems = feedAdapter.getItems();
    for (FeedItem feedItem : feedItems) {
